...
export default function Custom500() {
  return (
    <>
      <Head>
        <title>Ошибка сервера — Новости Иркутска</title>
        <meta name="description" content="Произошла внутренняя ошибка сервера. Попробуйте обновить страницу или вернуться позже." />
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-6 text-center">
              ...
              <h1 className="display-1 fw-bold text-muted mb-3">500</h1>
              <h2 className="h3 fw-bold mb-3">Ошибка сервера</h2>
              <p className="lead text-muted mb-4">
                Произошла внутренняя ошибка сервера. Мы работаем над устранением проблемы.
              </p>
