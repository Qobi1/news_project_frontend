// Build-time script to generate static HTML files with proper meta tags
// This ensures meta tags are visible in page source

const fs = require('fs');
const path = require('path');

// Mock article data - in production, fetch from your API
const mockArticles = [
  {
    id: 1,
...
function generateStaticHTML() {
  ...
  console.log('These files have proper meta tags visible in page source.');
}
...
module.exports = { generateStaticHTML, generateArticleHTML };
